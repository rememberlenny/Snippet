  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved coupon as @coupon" do
        ...
        post :create, {:coupon => { "name" => "invalid value" }}, valid_session
        assigns(:coupon).should be_a_new(Coupon)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested coupon" do
        ...
        Coupon.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => coupon.to_param, :coupon => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the coupon as @coupon" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Coupon.any_instance.stub(:save).and_return(false)
        put :update, {:id => coupon.to_param, :coupon => { "name" => "invalid value" }}, valid_session
        assigns(:coupon).should eq(coupon)
      end
