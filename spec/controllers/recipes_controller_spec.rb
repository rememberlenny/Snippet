...
describe RecipesController do
  ...
  let(:valid_attributes) { { "dishType" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved recipe as @recipe" do
        ...
        post :create, {:recipe => { "dishType" => "invalid value" }}, valid_session
        assigns(:recipe).should be_a_new(Recipe)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested recipe" do
        ...
        Recipe.any_instance.should_receive(:update).with({ "dishType" => "MyString" })
        put :update, {:id => recipe.to_param, :recipe => { "dishType" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the recipe as @recipe" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Recipe.any_instance.stub(:save).and_return(false)
        put :update, {:id => recipe.to_param, :recipe => { "dishType" => "invalid value" }}, valid_session
        assigns(:recipe).should eq(recipe)
      end
